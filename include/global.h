...
#define VARARG(m, ...) CAT(m, NARG(__VA_ARGS__))(__VA_ARGS__)
#define NARG(...) NARG_(_, ##__VA_ARGS__, __VA_ARGS__ )
#define NARG_(_, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad, ae, af, N, ...) N
