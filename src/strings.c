...
const u8 gText_Pokemon[] = _("{P}MON");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “{P}MON.”{PAUSE 96}\p");
...
const u8 gText_ThePokemonList[] = _("the {P}MON LIST");
...
#if UK
const u8 gText_DefenseCurl16BP[] = _("DEFENCE CURL{CLEAR_TO 0x4E}16BP");
#else
...
#if UK
const u8 gUnknown_085EEA55[] = _("DEFENCE");
#else
