...
const u32 gMonFrontPic_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/front.4bpp.lz");
...
#if UK
const u32 gTilesetTiles_General[] = INCBIN_U32("data/tilesets/primary/general/tiles_uk.4bpp.lz");
#else
