const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_KAKUNA] = gMonFootprint_Metapod,
    ...
    [SPECIES_EKANS] = gMonFootprint_Metapod,
    [SPECIES_ARBOK] = gMonFootprint_Metapod,
    ...
    [SPECIES_ZUBAT] = gMonFootprint_Metapod,
    ...
    [SPECIES_DIGLETT] = gMonFootprint_Metapod,
    [SPECIES_DUGTRIO] = gMonFootprint_Metapod,
    ...
    [SPECIES_WEEPINBELL] = gMonFootprint_Metapod,
    [SPECIES_VICTREEBEL] = gMonFootprint_Metapod,
    [SPECIES_TENTACOOL] = gMonFootprint_Metapod,
    [SPECIES_TENTACRUEL] = gMonFootprint_Metapod,
    [SPECIES_GEODUDE] = gMonFootprint_Metapod,
    ...
    [SPECIES_SEEL] = gMonFootprint_Metapod,
    [SPECIES_DEWGONG] = gMonFootprint_Metapod,
    [SPECIES_GRIMER] = gMonFootprint_Metapod,
    [SPECIES_MUK] = gMonFootprint_Metapod,
    [SPECIES_SHELLDER] = gMonFootprint_Metapod,
    [SPECIES_CLOYSTER] = gMonFootprint_Metapod,
    [SPECIES_GASTLY] = gMonFootprint_Metapod,
    [SPECIES_HAUNTER] = gMonFootprint_Metapod,
    [SPECIES_GENGAR] = gMonFootprint_Gengar,
    [SPECIES_ONIX] = gMonFootprint_Metapod,
    ...
    [SPECIES_VOLTORB] = gMonFootprint_Metapod,
    [SPECIES_ELECTRODE] = gMonFootprint_Metapod,
    [SPECIES_EXEGGCUTE] = gMonFootprint_Metapod,
    ...
    [SPECIES_KOFFING] = gMonFootprint_Metapod,
    [SPECIES_WEEZING] = gMonFootprint_Metapod,
    ...
    [SPECIES_HORSEA] = gMonFootprint_Metapod,
    [SPECIES_SEADRA] = gMonFootprint_Metapod,
    [SPECIES_GOLDEEN] = gMonFootprint_Metapod,
    [SPECIES_SEAKING] = gMonFootprint_Metapod,
    [SPECIES_STARYU] = gMonFootprint_Weedle,
    [SPECIES_STARMIE] = gMonFootprint_Weedle,
    ...
    [SPECIES_MAGIKARP] = gMonFootprint_Metapod,
    [SPECIES_GYARADOS] = gMonFootprint_Metapod,
    [SPECIES_LAPRAS] = gMonFootprint_Metapod,
    [SPECIES_DITTO] = gMonFootprint_Metapod,
    ...
    [SPECIES_DRATINI] = gMonFootprint_Metapod,
    [SPECIES_DRAGONAIR] = gMonFootprint_Metapod,
    ...
    [SPECIES_CROBAT] = gMonFootprint_Metapod,
    [SPECIES_CHINCHOU] = gMonFootprint_Metapod,
    [SPECIES_LANTURN] = gMonFootprint_Metapod,
    ...
    [SPECIES_BELLOSSOM] = gMonFootprint_Metapod,
    ...
    [SPECIES_SUNKERN] = gMonFootprint_Metapod,
    ...
    [SPECIES_MISDREAVUS] = gMonFootprint_Metapod,
    [SPECIES_UNOWN] = gMonFootprint_Metapod,
    [SPECIES_WOBBUFFET] = gMonFootprint_Wobbuffet,
    [SPECIES_GIRAFARIG] = gMonFootprint_Girafarig,
    [SPECIES_PINECO] = gMonFootprint_Metapod,
    [SPECIES_FORRETRESS] = gMonFootprint_Metapod,
    [SPECIES_DUNSPARCE] = gMonFootprint_Metapod,
    [SPECIES_GLIGAR] = gMonFootprint_Gligar,
    [SPECIES_STEELIX] = gMonFootprint_Metapod,
    [SPECIES_SNUBBULL] = gMonFootprint_Snubbull,
    [SPECIES_GRANBULL] = gMonFootprint_Granbull,
    [SPECIES_QWILFISH] = gMonFootprint_Metapod,
    ...
    [SPECIES_PUPITAR] = gMonFootprint_Metapod,
    ...
    [SPECIES_SILCOON] = gMonFootprint_Metapod,
    [SPECIES_BEAUTIFLY] = gMonFootprint_Beautifly,
    [SPECIES_CASCOON] = gMonFootprint_Metapod,
    ...
    [SPECIES_MASQUERAIN] = gMonFootprint_Metapod,
    [SPECIES_WAILMER] = gMonFootprint_Metapod,
    [SPECIES_WAILORD] = gMonFootprint_Metapod,
    ...
    [SPECIES_BARBOACH] = gMonFootprint_Metapod,
    [SPECIES_WHISCASH] = gMonFootprint_Metapod,
    [SPECIES_LUVDISC] = gMonFootprint_Metapod,
    [SPECIES_CORPHISH] = gMonFootprint_Corphish,
    [SPECIES_CRAWDAUNT] = gMonFootprint_Crawdaunt,
    [SPECIES_FEEBAS] = gMonFootprint_Metapod,
    [SPECIES_MILOTIC] = gMonFootprint_Metapod,
    [SPECIES_CARVANHA] = gMonFootprint_Metapod,
    [SPECIES_SHARPEDO] = gMonFootprint_Metapod,
    ...
    [SPECIES_SPHEAL] = gMonFootprint_Metapod,
    [SPECIES_SEALEO] = gMonFootprint_Metapod,
    [SPECIES_WALREIN] = gMonFootprint_Metapod,
    [SPECIES_CACNEA] = gMonFootprint_Cacnea,
    [SPECIES_CACTURNE] = gMonFootprint_Cacturne,
    [SPECIES_SNORUNT] = gMonFootprint_Snorunt,
    [SPECIES_GLALIE] = gMonFootprint_Metapod,
    [SPECIES_LUNATONE] = gMonFootprint_Metapod,
    [SPECIES_SOLROCK] = gMonFootprint_Metapod,
    [SPECIES_AZURILL] = gMonFootprint_Azurill,
    [SPECIES_SPOINK] = gMonFootprint_Metapod,
    ...
    [SPECIES_DUSKULL] = gMonFootprint_Metapod,
    ...
    [SPECIES_GULPIN] = gMonFootprint_Metapod,
    [SPECIES_SWALOT] = gMonFootprint_Metapod,
    ...
    [SPECIES_CLAMPERL] = gMonFootprint_Metapod,
    [SPECIES_HUNTAIL] = gMonFootprint_Metapod,
    [SPECIES_GOREBYSS] = gMonFootprint_Metapod,
    [SPECIES_ABSOL] = gMonFootprint_Absol,
    [SPECIES_SHUPPET] = gMonFootprint_Metapod,
    [SPECIES_BANETTE] = gMonFootprint_Banette,
    [SPECIES_SEVIPER] = gMonFootprint_Metapod,
    [SPECIES_ZANGOOSE] = gMonFootprint_Zangoose,
    [SPECIES_RELICANTH] = gMonFootprint_Metapod,
    [SPECIES_ARON] = gMonFootprint_Aron,
    [SPECIES_LAIRON] = gMonFootprint_Lairon,
    [SPECIES_AGGRON] = gMonFootprint_Aggron,
    [SPECIES_CASTFORM] = gMonFootprint_Metapod,
    ...
    [SPECIES_ANORITH] = gMonFootprint_Metapod,
    ...
    [SPECIES_RAYQUAZA] = gMonFootprint_Metapod,
    ...
    [SPECIES_CHIMECHO] = gMonFootprint_Metapod,
