const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_KAKUNA] = sMetapodLevelUpLearnset,
    ...
    [SPECIES_MACHAMP] = sMachokeLevelUpLearnset,
    ...
    [SPECIES_GOLEM] = sGravelerLevelUpLearnset,
    ...
    [SPECIES_GENGAR] = sHaunterLevelUpLearnset,
    ...
    [SPECIES_TOGETIC] = sTogepiLevelUpLearnset,
    ...
    [SPECIES_SCIZOR] = sScytherLevelUpLearnset,
    ...
    [SPECIES_OLD_UNOWN_B] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_C] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_D] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_E] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_F] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_G] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_H] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_I] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_J] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_K] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_L] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_M] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_N] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_O] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_P] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Q] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_R] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_S] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_T] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_U] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_V] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_W] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_X] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Y] = sTyrogueLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Z] = sTyrogueLevelUpLearnset,
    ...
    [SPECIES_SILCOON] = sMetapodLevelUpLearnset,
    [SPECIES_BEAUTIFLY] = sBeautiflyLevelUpLearnset,
    [SPECIES_CASCOON] = sMetapodLevelUpLearnset,
    ...
    [SPECIES_FEEBAS] = sMagikarpLevelUpLearnset,
